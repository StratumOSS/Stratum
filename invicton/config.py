...
class Settings(BaseSettings):
    ...
    invicton_secret_key: str | None = None
    invicton_admin_token: str | None = None
    invicton_agent_require_confirmation: bool = True
    debug: bool = False
    strict_plugins: bool = True
    registry_url: str = "https://raw.githubusercontent.com/invicton/Invicton/main/blueprints"
