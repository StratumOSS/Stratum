...
Invicton's goal: **the layer that makes Ansible-Lockdown + OpenSCAP + every major
...
- [ ] CIS Level 2 coverage for every OS that supports it
      ([#1](https://github.com/invicton/Invicton/issues/1),
      [#2](https://github.com/invicton/Invicton/issues/2),
      [#3](https://github.com/invicton/Invicton/issues/3))
- [ ] Ubuntu 24.04 blueprints ([#4](https://github.com/invicton/Invicton/issues/4))
- [ ] First STIG blueprints ([#7](https://github.com/invicton/Invicton/issues/7))
...
CI. Invicton should be the OS-hardening tool an agent can operate correctly:
...
- [ ] Interop guides: Invicton with Packer, Invicton + Ansible-Lockdown,
...
Open a [Discussion](https://github.com/invicton/Invicton/discussions) or an
