...
from invicton import __version__
from invicton.api import agent as agent_api
from invicton.api import api_keys as api_keys_api
from invicton.api import auditor, blueprints, builder, integrations, plugins, ui
from invicton.api import pipeline as pipeline_api
from invicton.api import registry as registry_api
from invicton.api import system as system_api
from invicton.api import webhooks as webhooks_api
from invicton.api.integrations import credential_store
from invicton.config import settings
from invicton.core.auth import require_admin, require_admin_or_key
from invicton.core.registry import RegistrySource, init_registry
from invicton.core.sysdeps import check_system_deps
from invicton.paths import STATIC_DIR
...
async def lifespan(app: FastAPI):
    from invicton.core.auth import get_admin_token
    ...
    from invicton.core.auditor import load_jobs as _load_audit_jobs

    _load_audit_jobs()
    logger.info("Audit job store ready")

    from invicton.core.api_keys import load_keys as _load_api_keys

    _load_api_keys()
    logger.info("API key store ready")

    from invicton.core.notifications import load_webhooks as _load_webhooks
