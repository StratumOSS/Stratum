...
Invicton is a single-operator, self-hosted tool with no reverse proxy assumed
...
check, see ``invicton.api.pipeline``) is gated by one of the two dependencies
below:
...
from invicton.core.api_keys import verify_key
...
_UNAUTHORIZED = HTTPException(
    ...
    headers={"WWW-Authenticate": 'Basic realm="Invicton"'},
)
...
def get_admin_token() -> str:
    ...
    try:
        ...
        pass
    logger.warning(
        "No INVICTON_ADMIN_TOKEN set — generated an admin token and saved it to %s. "
