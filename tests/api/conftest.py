...
def app():
    ...
    from invicton.main import app as _app
...
def mock_run_image_scan():
    ...
    from invicton.core.auditor import AuditStatus
    ...
    with (
        patch("invicton.core.auditor.run_image_scan", side_effect=_fake_scan),
        patch("invicton.api.auditor.audit_service.run_image_scan", side_effect=_fake_scan),
        patch("invicton.api.pipeline.audit_service.run_image_scan", side_effect=_fake_scan),
    ):
        yield
