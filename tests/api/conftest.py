...
def app():
    ...
    from stratum.main import app as _app
...
def mock_run_image_scan():
    ...
    from stratum.core.auditor import AuditStatus
    ...
    with (
        patch("stratum.core.auditor.run_image_scan", side_effect=_fake_scan),
        patch("stratum.api.auditor.audit_service.run_image_scan", side_effect=_fake_scan),
        patch("stratum.api.pipeline.audit_service.run_image_scan", side_effect=_fake_scan),
    ):
        yield
