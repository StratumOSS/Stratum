...
Stratum is a single-operator, self-hosted tool with no reverse proxy assumed
...
check, see ``stratum.api.pipeline``) is gated by one of the two dependencies
below:
...
from stratum.core.api_keys import verify_key
...
def get_admin_token() -> str:
    ...
    try:
        ...
        pass
    logger.warning(
        "No STRATUM_ADMIN_TOKEN set — generated an admin token and saved it to %s. "
