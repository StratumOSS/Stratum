...
Covers the previously uncovered paths in:
  - invicton/core/llm/anthropic_backend.py  (was 28%)
  - invicton/core/llm/openai_backend.py     (was 35%)
  - invicton/core/llm/bedrock_backend.py    (was 43%)
  - invicton/core/llm/factory.py            (was 97%)
"""
...
from invicton.core.llm.base import TextBlock, ToolUseBlock
from invicton.core.llm.bedrock_backend import (
    BedrockBackend,
...
class TestFactory:
    def test_provider_status_anthropic_no_key(self, monkeypatch):
        ...
        from invicton.core.llm.factory import provider_status
    ...
    def test_provider_status_openai_with_key(self, monkeypatch):
        monkeypatch.setenv("INVICTON_LLM_API_KEY", "sk-test")
        monkeypatch.setenv("INVICTON_LLM_PROVIDER", "openai")
        from invicton.core.llm.factory import provider_status
    ...
    def test_provider_status_unknown_provider(self, monkeypatch):
        monkeypatch.setenv("INVICTON_LLM_PROVIDER", "groq")
        from invicton.core.llm.factory import provider_status
    ...
    def test_get_backend_anthropic(self, monkeypatch):
        monkeypatch.setenv("INVICTON_LLM_PROVIDER", "anthropic")
        from invicton.core.llm.anthropic_backend import AnthropicBackend
        from invicton.core.llm.factory import get_backend
    ...
    def test_get_backend_unknown_raises(self, monkeypatch):
        monkeypatch.setenv("INVICTON_LLM_PROVIDER", "invalid_provider")
        from invicton.core.llm.factory import get_backend
