...
Not every OS Invicton could theoretically support is actually ready for a blueprint yet. A
...
either a ComplianceAsCode/content profile PR or a new `ansible-lockdown` role — not a Invicton
blueprint that can't actually remediate anything yet.

## Step 1 — Fork and clone

```bash
git clone https://github.com/<your-handle>/Invicton.git
cd Invicton
```
...
PR checklist:
- [ ] Blueprint validates against the Invicton schema
...
```yaml
# invicton_version: The Invicton schema version this blueprint targets.
invicton_version: "0.5.1"
...
target:
  # os: Invicton OS identifier. Must match a key in invicton/core/os_catalog.py's OS_CATALOG.
  os: rocky9
  arch: x86_64
