...
async def test_signature_header_has_sha256_prefix():
    """The X-Invicton-Signature header must start with 'sha256='."""
    ...
    assert "X-Invicton-Signature" in captured_headers, "X-Invicton-Signature header must be present"
    sig = captured_headers["X-Invicton-Signature"]
